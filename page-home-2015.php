...
<div id="myModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Sign up for periodic updates from New River.</h4>
      </div>
      <div class="modal-body">
       <p>Periodically (two or three times a month) we send email updates about what's happing around here. If you want to be kept up to date, give us your info below.</p>
